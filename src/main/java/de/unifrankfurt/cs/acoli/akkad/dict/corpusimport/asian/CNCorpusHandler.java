...
package de.unifrankfurt.cs.acoli.akkad.dict.corpusimport.asian;
...
import de.unifrankfurt.cs.acoli.akkad.dict.corpusimport.util.CNXMLToSet;
import de.unifrankfurt.cs.acoli.akkad.dict.dicthandler.DictHandling;
import de.unifrankfurt.cs.acoli.akkad.dict.dicthandler.asian.CNDictHandler;
...
public class CNCorpusHandler extends CorpusHandlerAPI  {
    ...
    /**Splitting map for Crossvalidation.*/
    ...
    /**Current number of lines to segment and the start value.*/
    ...
    /**Indicates if a percentage split should be used.*/
