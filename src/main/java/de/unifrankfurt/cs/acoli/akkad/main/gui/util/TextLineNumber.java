 ...
 *  of a JScrollPane.
 *
 *  Code modified from https://tips4java.wordpress.com/2009/05/23/text-component-line-number/
 */
        ...
        implements DocumentListener, PropertyChangeListener
{
     ...
     */
    public TextLineNumber(JTextComponent component,Map<Integer,String> switches)
    {
     ...
     */
    public TextLineNumber(JTextComponent component, int minimumDisplayDigits,Map<Integer,String> colorswitches)
    {
