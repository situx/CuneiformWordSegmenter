...
public enum Files {
    ...
    WINNOW("winnow"), REVERSE("_reverse"), BOUNDARYDIR("boundary/"),
    MORFESSORSUFFIX("_morfessor.txt"), SCIM_DIR("scim/"), SCIM_HEADER("scim_header.txt"),SCIM_FOOTER("scim_footer.txt"),
    FOOTER("_footer"), HEADER("_header"), MODELSUFFIX(".model"), XMLSUFFIX(".xml");
