 ...
 * Date: 26.10.13
 * Time: 14:11
 * DictHandler for the Sumerian language.
 */
public class SumerianDictHandler extends CuneiDictHandler {
    /**
     * Constructor for this class.
     * @param stopchars stopchars to consider
     */
    public SumerianDictHandler(List<String> stopchars){
        super(stopchars,CharTypes.SUMERIANCHAR,new POSTagger(new TreeMap<String, Color>(),CharTypes.SUMERIANCHAR.getLocale()));
    }
    ...
    public void importDictFromXML(String filepath) throws ParserConfigurationException, SAXException, IOException {
        ...
        parser.parse(filepath,new AkkadianImportHandler(Options.FILLDICTIONARY,this,this.dictmap,this.translitToWordDict,this.transcriptToWordDict, CharTypes.SUMERIANCHAR));
    }
    ...
    public void importMappingFromXML(String filepath) throws ParserConfigurationException, SAXException, IOException {
        ...
        InputSource is = new InputSource(in);
        is.setEncoding(Tags.UTF8.toString());
        parser.parse(filepath,new AkkadianImportHandler(Options.FILLMAP,this,this.dictmap,this.translitToCharMap,this.transcriptToWordDict,CharTypes.SUMERIANCHAR));
    }
    ...
    public void importReverseDictFromXML(final String filepath) throws ParserConfigurationException, SAXException, IOException {
        ...
        InputSource is = new InputSource(in);
        is.setEncoding(Tags.UTF8.toString());
        AkkadianImportHandler imp=new AkkadianImportHandler(Options.REVERSEDICT,this,this.reversedictionary,this.reverseTranslitToWordDict,this.reverseTranscriptToWordDict,CharTypes.SUMERIANCHAR);
        parser.parse(in,imp);
        parser.reset();
    }
    ...
    public void parseDictFile(File file) throws IOException, ParserConfigurationException, SAXException {
        ...
        parser.parse(file, new CuneiSignImportHandler(this.dictmap,this.dictionary,this.translitToCharMap,this.translitToWordDict,this.transcriptToWordDict, CharTypes.SUMERIANCHAR));
    }
