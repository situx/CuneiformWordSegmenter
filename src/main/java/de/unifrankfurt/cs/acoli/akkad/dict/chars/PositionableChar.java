...
public abstract class PositionableChar extends LangChar{
    ...
    /**Indicates the number of single transliterations.*/
    ...
    public Transliteration getFirstEndTransliteration() {
        ...
        return this.transliterations.keySet().iterator().hasNext()?this.transliterations.keySet().iterator().next():new Transliteration("","");
    }
    ...
    public Transliteration getMostProbableBeginTransliteration(final Integer position) {
        ...
        for (Transliteration transliteration : this.transliterations.keySet()) {
            if (transliteration.isBeginTransliteration() && transliteration.getOccuranceAtPosition(position) != null && transliteration.getOccuranceAtPosition(position).getOccuranceAmount() > maxprob) {
    ...
    public Transliteration getMostProbableEndTransliteration(final Integer position) {
        ...
        Transliteration result = this.transliterations.keySet().iterator().next();
        for (Transliteration transliteration : this.transliterations.keySet()) {
            if (transliteration.isEndTransliteration() && transliteration.getOccuranceAtPosition(position) != null && transliteration.getOccuranceAtPosition(position).getOccuranceAmount() > maxprob) {
                maxprob = transliteration.getOccuranceAtPosition(position).getOccuranceAmount();
                result = transliteration;
    ...
    public Transliteration getMostProbableMiddleTransliteration(final Integer position) {
        ...
        Transliteration result = this.transliterations.keySet().iterator().next();
        for (Transliteration transliteration : this.transliterations.keySet()) {
            if (transliteration.isMiddleTransliteration() && transliteration.getOccuranceAtPosition(position) != null && transliteration.getOccuranceAtPosition(position).getOccuranceAmount() > maxprob) {
                maxprob = transliteration.getOccuranceAtPosition(position).getOccuranceAmount();
                result = transliteration;
    ...
    public Transliteration getMostProbableSingleTransliteration(final Integer position) {
        ...
        Transliteration result = this.transliterations.keySet().iterator().next();
        for (Transliteration transliteration : this.transliterations.keySet()) {
            if (transliteration.isSingleTransliteration() && transliteration.getOccuranceAtPosition(position) != null && transliteration.getOccuranceAtPosition(position).getOccuranceAmount() > maxprob) {
                maxprob = transliteration.getOccuranceAtPosition(position).getOccuranceAmount();
                result = transliteration;
