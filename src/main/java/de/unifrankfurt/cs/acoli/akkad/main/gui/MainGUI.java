...
//could just importhandler javax.swing.* and java.awt.* etc..
...
/**
 * Main GUI that is shown when starting the program.
 */
public class MainGUI extends GUIFormat {
    /**Progress indicator.*/
    public static Integer progress=0;
    /**Progress monitor.*/
    protected static ProgressMonitor progressBar;
    /**The main class for accessing needed program components.*/
    private Main main;
    ...
    public MainGUI()
    {
        ...
        this.setTitle(bundle.getString("wordsegmentation"));
        this.setLayout(new GridBagLayout());
        final JTabbedPane tabbedPane = new JTabbedPane();
        //tabbedPane.setPreferredSize(new Dimension(700,490));
        getContentPane().add(tabbedPane);
        tabbedPane.addTab(bundle.getString("simple"),new MainPanelSimple(main));
        tabbedPane.addTab(bundle.getString("advanced"),new MainPanel(main));
        ...
        trainfilebutton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent actionEvent) {
                ...
                if (actionEvent.getSource() == trainfilebutton) {
                    int returnVal = trainfilechooser.showOpenDialog(MainGUI.this);
        ...
        testfilebutton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent actionEvent) {
                ...
                if (actionEvent.getSource() == testfilebutton) {
                    int returnVal = testfilechooser.showOpenDialog(MainGUI.this);
        ...
        modelfilebutton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent actionEvent) {
                ...
                if (actionEvent.getSource() == modelfilebutton) {
                    int returnVal = modelfilechooser.showOpenDialog(MainGUI.this);
        ...
        startclassification.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                if (testfilefield.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(MainGUI.this, bundle.getString("notestfile"));
                } else {
                       Thread thread=new Thread() {
                                        public void run() {
                                            try {
                                                progressBar = new ProgressMonitor(MainGUI.this,
                                                        bundle.getString("nowclassifying")+" "+testfilefield.getText(),
                                                        "", 0, 100);
                                                progressBar.setProgress(0);
                                                progressBar.setNote(bundle.getString("nowclassifying")+" "+testfilefield.getText());
                                                ...
                                                /*String resultfile=/*currentmethod.getHasFeatureSet()?testfilefield.getText().substring(testfilefield.getText().lastIndexOf('/')+1,
                                                        ...
                                                        testfilefield.getText().lastIndexOf('.'))
                                                                ...
                                                                +"_"+((TransliterationMethod)transliterationchooser.getSelectedItem()).getShortlabel().toLowerCase()
                                                                +Files.RESULT.toString();*/
                                                /*MainGUI.this.resultStr = main.startClassification(
                                                ...
                                                String resultfile=MainGUI.this.resultStr.substring(MainGUI.this.resultStr.lastIndexOf("/")+1);
                                               ...
                                               evalResultList,testfile
                                                        ,resultfile,selected,Locale.ENGLISH.toString(),false,main.dictHandler,(TestMethod)testmethodchooser.getSelectedItem()
                ...
                if (testfilefield.getText().isEmpty()) {
                    ...
                    for(MethodEnum currentmethod:list.getSelectedValuesList()){
                        ...
                        resultfilelist.add(resultfile);
                            ...
                            MainGUI.this.resultStr = main.startClassification(trainingfilefield.getText(), testfilefield.getText(),modelfilefield.getText(), (ClassificationMethod)currentmethod,
                    ...
                    ChartGUI chart = new ChartGUI(bundle.getString("result") +
                            ...
                            testfilefield.getText(), resultfilelist.get(0),list.getSelectedValuesList(), Locale.ENGLISH.toString(),true,main.dictHandler,(TestMethod)testmethodchooser.getSelectedItem()
                    );
                    progressBar.setProgress(100);
                    chart.setTextAreaContents(resultStr);
                    progressBar.close();
    ...
    /**
     * Refreshes the progressbar with a new progress value.
     */
    public static void refreshProgressBar(){
        if(MainGUI.progressBar!=null)
            MainGUI.progressBar.setProgress(progress);
    }
    /**
     * Refreshes the progressbar with a new message.
     */
    public static void refreshProgressBarMessage(String note){
        if(MainGUI.progressBar!=null)
            MainGUI.progressBar.setNote(note);
    }
