...
public class Following implements Comparable<Following>{
    ...
    public void addBoundariesFollowBoundaries() {
        this.boundariesFollowBoundaries++;
    }

    public void addBoundariesFollowContinuations() {
        this.boundariesFollowContinuations++;
    }

    public void addContinuationFollowsBoundary() {
        this.continuationFollowsBoundary++;
    }

    public void addContinuationFollowsContinuation() {
    ...
    public String toXML(){
        ...
        try {
            ...
            for(String key:this.preceding.keySet()){
                writer.writeStartElement(Tags.PRECEDING.toString());
                writer.writeAttribute(Tags.PRECEDING.toString(), key);
